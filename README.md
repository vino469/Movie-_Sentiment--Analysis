...
Sentiment: Positive
Input
The movie was disappointing and the story was very boring.
Output
Sentiment: Negative
Model Performance
...
These metrics help evaluate how effectively the model classifies movie reviews.

Future Enhancements
Implement advanced NLP models such as BERT and Transformers.
...
This project demonstrates how Natural Language Processing and Machine Learning techniques can be applied to analyze text data and classify movie reviews based on sentiment.

The combination of TF-IDF Vectorization and Logistic Regression provides an effective approach for sentiment classification, while Streamlit enables an interactive real-time prediction system.
